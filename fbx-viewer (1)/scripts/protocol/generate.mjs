...
const ts = [
  ...
  "export interface CapabilitiesResult { protocol: \"auvra.host/1\"; methods: [\"host.ping\", \"host.getCapabilities\"]; projectMethods: Method[]; providerMethods: Method[]; }",
  ...
  "export interface Event { protocol: \"auvra.host/1\"; type: \"event\"; event: \"host.session\" | \"host.revision\" | \"project.status\" | \"project.opening\" | \"project.opened\" | \"project.closing\" | \"project.closed\" | \"project.revision\" | \"project.dirty\" | \"project.readOnly\" | \"project.progress\" | \"project.recovery\" | \"provider.job\" | \"provider.status\" | \"provider.progress\" | \"provider.recovery\"; session: SessionId; revision: Revision; payload: Record<string, unknown>; }",
...
const py = [
  ...
  "class CapabilitiesResult(TypedDict, total=False):", '    protocol: Literal["auvra.host/1"]', '    methods: list[Method]', "    projectMethods: list[Method]", "    providerMethods: list[Method]",
  ...
  "class Event(TypedDict):", '    protocol: Literal["auvra.host/1"]', '    type: Literal["event"]', '    event: Literal["host.session", "host.revision", "project.status", "project.opening", "project.opened", "project.closing", "project.closed", "project.revision", "project.dirty", "project.readOnly", "project.progress", "project.recovery", "provider.job", "provider.status", "provider.progress", "provider.recovery"]', "    session: SessionId", "    revision: Revision", "    payload: dict[str, object]",
